...
**デモ内容:**
• 健康スコア概要: ダッシュボードでの総合スコア表示とWHO基準の達成度
...
**デモ内容:**
• 筋トレ記録: セット数とレップ数の詳細入力画面
• 有酸素運動記録: ランニングやサイクリングの時間と距離入力

| **筋トレ記録の入力**                                                                  | **有酸素運動の記録**                                                       |
| ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| <img src="./docs/demos/strength-training-input.gif" alt="筋トレ記録入力" width="350"> | <img src="./docs/demos/cardio-input.gif" alt="有酸素運動記録" width="350"> |
| • セット数、レップ数を詳細記録<br>• 複数セットの入力に対応                            | • 運動時間と距離を入力<br>• ランニング、サイクリングなどに対応             |
...
**デモ内容:**
• 週次統計: 今週のワークアウト回数と前週比較
• 月次統計: 今月の総レップ数・距離と前月比較

| **週次統計**                                                         | **月次統計**                                                          |
| -------------------------------------------------------------------- | --------------------------------------------------------------------- |
| <img src="./docs/demos/weekly-stats.gif" alt="週次統計" width="350"> | <img src="./docs/demos/monthly-stats.gif" alt="月次統計" width="350"> |
| • 今週のワークアウト回数を集計<br>• 前週との比較で成長率を可視化     | • 今月の総レップ数・総距離を表示<br>• 前月比で長期的な進捗を確認      |
...
**デモ内容:**
• アカウント連携: OAuth認証によるStrava接続プロセス
• データ同期: Stravaアクティビティの自動取り込み
...
**デモ内容:**
• モバイル表示: iPhone 14 Proでの最適化されたレイアウト表示
