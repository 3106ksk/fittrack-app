...
運動データをWHO基準の健康指標に変換し、エビデンスベースのフィードバックを提供。単なる記録から「健康改善の見える化」へ。

| 操作デモ | 説明 |
|---------|------|
| ![健康スコア概要](./docs/demos/health-score-overview.gif) | **総合健康スコアの可視化**<br>75/100点の総合評価と有酸素・筋力の個別スコア表示。<br>WHO推奨運動量の達成状況を一目で確認 |
| ![スコア即時更新](./docs/demos/health-score-instant-update.gif) | **運動記録→スコアの即時反映**<br>30分のランニング記録で健康スコアが72→75点に上昇。<br>リアルタイムフィードバックでモチベーション維持 |
| ![週間成長の可視化](./docs/demos/health-score-weekly-growth.gif) | **前週比+250%の成長を可視化**<br>週間ワークアウト4回→14回の大幅改善。<br>継続による健康効果を数値で実感 |

**主な特徴:**
- 🎯 **WHO基準準拠**: 週150分の有酸素運動、週2回の筋トレを基準に評価
- 📊 **3つのスコア体系**: 総合スコア（100点満点）、有酸素スコア、筋力スコア
- ⚡ **即時フィードバック**: 運動記録と同時にスコアが更新、成長を即座に実感
- 📈 **週間トレンド分析**: 前週比での改善率を自動計算、継続のモチベーション向上
